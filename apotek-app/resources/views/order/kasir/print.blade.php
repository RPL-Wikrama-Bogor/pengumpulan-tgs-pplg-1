...
<body>
    ...
    <div id="receipt">
        ...
        <div id="mid">
            <div class="info">
                <p>
                    Alamat : China brayyy <br>
                    Email  : Minghao@gmail.com <br>
                    Phone  : +62-7672-6482-6644 <br>
                </p>
            </div>
        </div>
        ...
        <div id="bot">
            ...
            <div id="legalcopy">
                <p class="legal"><strong>Terima kasih atas pembelian anda ! </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, reiciendis. Modi excepturi provident consequuntur fugit?</p>
            </div>            
        </div>
    </div>
