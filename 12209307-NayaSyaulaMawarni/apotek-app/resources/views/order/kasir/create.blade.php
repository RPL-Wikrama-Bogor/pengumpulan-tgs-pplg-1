...
@section('content')
    <div class="container mt-3">
        <form action="{{ route('kasir.order.store') }}" class="card m-auto p-5" method="POST">
            ...
            <div class="mb-3 row">
                <label for="name-customer" class="col-sm-2 col-form-label">Nama Pembeli</label>
                <div class="col-sm-10">
...
@push('script')
    <script>
        ...
        $("#add-select").on("click", function () {
            ...
            // append : tambahkan element html dibagian sblm penutup tang penutup terkait (sblm penutup tag yang id nya wrap=medicines)
