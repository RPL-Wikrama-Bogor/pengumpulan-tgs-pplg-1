...
<div class="container">
    ...
    <div>
    <a href="<?= BASE_URL;?>/Pinjam/tambah" class="btn text-white" style="background-color: BLUE"> Peminjaman</a>
    </div>
    <div class="d-flex">
                  ...
                  <td> 
                    <?php
                        if ($status == 'belum kembali') {
                            ...
                            echo '<a href="' . BASE_URL . '/pinjam/edit/' . $row['id'] . '" class="btn"><i class="fa-solid fa-pen"></i></i></a>';
                        }
                    ?>
                        <a href="<?= BASE_URL ?>/pinjam/hapus/<?= $row['id'] ?>" class="btn" onclick="return confirm('Hapus data?');"><i class="fa-regular fa-trash-can"></i></i></a>
                  </td>
                </tr>
                <?php $no++; endforeach; ?>
        </tbody>
