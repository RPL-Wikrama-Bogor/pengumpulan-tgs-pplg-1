...
<body>
<div class="container">
    <a href="<?= BASE_URL;?>/Pinjam/index"><i class="fa-solid fa-circle-arrow-left fa-2xl" style="color: #004225; margin-top:2rem;"></i></a>
    ...
    <form action="<?=BASE_URL;?>/Pinjam/simpanPinjam" method="post">
        ...
        <div class="card-footer" style="float:right;">
            <button type="submit" class="btn  "  style="background-color: #004225; color: white; ">Submit</button>
        </div>
    </form>
</body>
</div>