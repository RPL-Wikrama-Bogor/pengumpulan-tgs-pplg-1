...
<body>
<div class="container">
    <h3 class="mb-3" style="text-align:center";>Daftar Peminjaman</h3>
    <div class="d-flex justify-content-between">
    <div>
    <a href="<?= BASE_URL;?>/Pinjam/tambah" class="btn text-white" style="background-color: #004225;">Tambah Peminjaman</a>
    </div>
    <div class="d-flex">
    <form action="<?= BASE_URL;?>/Pinjam/cari" method="post" class= "d-flex" style="margin-right: 0.5rem;">
        <input type="text" name="search" id="" class="form-control" style="border: solid 1px grey; margin-right: -0.1rem" placeholder="Cari Nama/Barang">
                ...
                <tr>
                  ...
                  <td>
                    <?php
                        ...
                        $status = "sudah kembali" ;
                        echo '<div style="background-color: #D21312; height: 1.7rem; text-align: center; color: white; margin-top: 0.5rem; border-radius: 7px;"> ' . $status .' </div>';
                        } 
                        else {
                  ...
                  <td> 
                    <?php
                        if ($status == 'belum kembali') {
                            ...
                            echo '<a href="' . BASE_URL . '/pinjam/edit/' . $row['id'] . '" class="btn btn-primary"><i class="fa-solid fas fa-paper-plane " style= font-size:14px;/></i></a>';
                        }
                    ?>
                        <a href="<?= BASE_URL ?>/pinjam/hapus/<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Hapus data?');"><i class="fa-solid fas fa-skull-crossbones" style= font-size:14px;></i></a>
                  </td>
                </tr>
                <?php $no++; endforeach; ?>
        </tbody>
