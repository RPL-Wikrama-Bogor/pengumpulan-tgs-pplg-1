        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="http://localhost/phpmyadmin/">Dashboard</a>
                  </li>
                  @if (Auth::check())
                    @if (Auth::user()->role == "admin")
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('student.home') }}">Kelola Akun</a>
                        </li>
                        @endif
                    ...
                    @if (Auth::user()->role == "guest")
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('guest.order.home') }}">Data Obat</a></li>
                            </ul>
                        </li>
                        @endif
                  <li class="nav-item">
