...
class MedicineController extends Controller
{
    ...
    {
        $medicines = Medicine::all(); // -> mengambil semua value dari model Medicine
    ...
    public function store(Request $request)
    {
        ...
        Medicine::create([ // -> panggil model karena model menampung tabel Medicine
            'name' => $request->name, // nama column => minta -> nama inputan (di view)
            'type' => $request->type,
            'price' => $request->price,
            'stock' => $request->stock,
        ]);

        // if all data = Medicine::create($request->all());
