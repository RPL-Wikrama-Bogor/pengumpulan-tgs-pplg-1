    ...
    <form action="<?= BASE_URL; ?>/buku/updateBuku" method="post">
        <div class="class-body">
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" name="jenis_barang" id="jenis_barang" value="<?= $data['buku']['jenis_barang'] ?>">
            ...
            <div class="form-group mb-3">
                ...
                <input type="date" class="form-control" id="tgl_pinjam" name="tgl_pinjam" value="<?= $data['buku']['tgl_pinjam'] ?>">
            </div>
            <div class="form-group mb-3">
                <label for="tgl_kembali">Tanggal Kembali</label>
                <input type="date" class="form-control" id="tgl_kembali" name="tgl_kembali" value="<?= $data['buku']['tgl_kembali'] ?>">
            </div>
