...
@section('content')
    ...
    <script>
        ...
        let no = 2;
        //ketika tag dengan id add-select di click jalankan dunc berikut
        $("#add-select").on("click", function() {
            ...
            let el = `<br><select name="medicines[]" id="medicines" class="form-select">
                ...
                // append : tambahkan element html dibagian sblm pentup tag penutup terkait(sblm penutup tag yang idnya wrap-medicines)
                $("#wrap-medicines").append(el);
                //increments variable noa gar angka yang muncul di option sellau bertambah 1 sesuai dengan jumlah selectnya
                no++;
        });
    </script>
@endpush
