...
@section('content')
    <form action="{{ route('medicine.update', $medicine['id']) }}" method="POST" class="card p-5">
        ...
        <div class="mb-3 row">
            <label for="name" class="col-sm-2 ccol-form-label"> Nama Obat :</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="name" class="col-sm-2 ccol-form-label"> Jenis Obat :</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="name" class="col-sm-2 ccol-form-label"> Harga Obat :</label>
            <div class="col-sm-10">
