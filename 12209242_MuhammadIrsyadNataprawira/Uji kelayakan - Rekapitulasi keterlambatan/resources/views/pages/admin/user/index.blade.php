...
@section('content')
    <div class="mt-5 max-w-full mx-10">
        <div class="container mb-5 flex gap-10 text-center">
            <div class="header">
                <h2 class="text-3xl font-semibold mb-2">Data User</h2>
                <p>Admin / Data User</p>
            </div>
        ...
        <div class="handle">
            <a href="{{route('user.create')}}" class="py-2 px-4 bg-yellow-500 hover:bg-yellow-600 transition duration-300 rounded-md text-white font-medium mb-5">Tambah Data User</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="flex gap-2 justify-center items-center">
                                <a href="{{ route('user.edit', $item['id']) }}"
                                    ...
                                    <form method="POST" action="{{ route('user.delete', $item->id) }}" onsubmit="return confirm('Are You Sure Want To Delete This?')">
                                        @csrf
                                        @method('DELETE')
