...
$proses = Order::create([
// data user id diambil dari id akun kasir yg sedang login
...
// kirim data order yg diambil td, bagian column id sebagai parameter path dari route print
 return redirect()->route('kasir.order.print', $order['id']);
        ...
        //jika tidak berhasil,maka diarahkan kembali ke halaman from dengan pesan pemberitahuan
...
// kembalikan atau hasilkan bentuk pdf dengan nama file tertentu
 return $pdf->download('receipt.pdf');
    ...
    // {
    //     $key = $request->date;
    //     $orders = Order::where('created_at', 'LIKE', '%'.$key.'%')
    //     ->simplePaginate(10);
