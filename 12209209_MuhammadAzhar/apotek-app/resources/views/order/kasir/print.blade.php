...
<div id="bot">
    ...
    <tr class="tabletitle">
        ...
        <div id="legalcopy">
        <p class="legal"><strong>Terima kasih atas pembelian Anda!</strong> Lorem ipsum dolor, consectetur adipisicing elit. Maiores natus et numquam ducimus dolorum tenetur.
        </p>
        </div>
        </div>
        </div>
