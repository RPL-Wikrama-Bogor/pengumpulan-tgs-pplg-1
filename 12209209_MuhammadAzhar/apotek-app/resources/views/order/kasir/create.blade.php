...
{{--div pembungkus untuk tambahan select yg akan muncut --}}
...
@push('script')
<script>
// definisikan na sebagai 2
let no = 2;
// ketika tag dengan id odd-select di click jalankan func berikut
$("#add-select").on("click", function() {
// tag htal yg akan ditambahkan/dimunculkan
...
// append tambahkan element ntal dibagian sala penutup tag penutup terkait [sble penetup tag yg td nya wrap-medicines) 
