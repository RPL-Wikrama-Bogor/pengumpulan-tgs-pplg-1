...
<td>Rp. {{ number_format($item['total price'], 0,',','.') }}</td>
{{--karna nana kasir terdapat pada table users, dan relasi antara order dan users telah didefinisikan pada function relasi bernama user. maka, untuk mengakses coluen pada table users melalui relasi antara keduanya dapat dilakukan dengan Svar ['namaFuncRelasi']['columnDariTableLainnya'] --}}
<td>{{ $item['user']['name'] }}</td>
<td>
<a href="" class="btn btn-secondary">Download Setruk</a>
</td>
</td>
@endforeach
</tbody>
